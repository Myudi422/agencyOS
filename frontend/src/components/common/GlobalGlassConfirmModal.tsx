...
export default function GlobalGlassConfirmModal() {
  const { isOpen, options, isLoading, closeConfirm, setIsLoading } = useConfirmStore();
  ...
  return (
    <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-xl animate-in fade-in duration-200">

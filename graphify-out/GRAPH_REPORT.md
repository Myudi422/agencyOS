...
- **Why does `User` connect `User` to `UserSubscription`, `competitors.py`, `kol.py`, `get_clients`, `models.py`, `statistics.py`, `posts.py`, `get_user_workspace`, `QueueService`, `require_user`, `reschedule_post`, `get_dashboard_overview`?**

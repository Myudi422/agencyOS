...
## Corpus Check
- 148 files · ~772,598 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1507 nodes · 3517 edges · 79 communities (60 shown, 19 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 427 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `be049cf5`
...
Cohesion: 0.07
Nodes (19): get_db(), Migration Script: Add social_account_id column to competitor_accounts table, Database Migration Script — Migrate database schema from Stripe to Midtrans.…, Migration Script: Add ai_brief column to posts table, Migration: Tambah tabel post_publish_results dan kolom baru ke posts. Jalankan:…, Database Migration — WA OTP Verification Menambah kolom phone_number &…, Reset Subscriptions Script — Clears all user subscriptions in DB. Run: python…, get_current_user_from_token() (+11 more)
...
Cohesion: 0.06
Nodes (80): Settings, PlanTier, Paket langganan — semua plan unlimited akun sosmed, beda di quota post., Subscription aktif milik satu user., Menyimpan OTP WhatsApp sementara untuk verifikasi sebelum claim trial., Setting, SubscriptionPlan, SubscriptionStatus (+72 more)
...
Cohesion: 0.09
Nodes (38): _ensure_utc(), get_calendar_posts(), _in_range(), _parse_and_ensure_utc(), Any, datetime, get, Session (+30 more)
...
Cohesion: 0.13
Nodes (43): AccountPlatform, ActivityLog, RoleEnum, SocialAccount, BlueskyConnectRequest, ChallengeResolveRequest, CookieLoginRequest, CredentialLoginRequest (+35 more)
...
### Community 27 - "User"
Cohesion: 0.16
Nodes (33): AccountStatus, User, AccountBriefingSchema, bulk_action(), BulkActionRequest, delete_account(), get_account_briefing(), get_account_watermark() (+25 more)
...
Cohesion: 0.06
Nodes (67): Script perbaikan langsung: Ambil hasil dari PostForMe API untuk semua post yang…, JobStatus, Post, PostPublishResult, PostStatus, PostTarget, PostType, PublishJob (+59 more)
...
Cohesion: 0.19
Nodes (21): Client, Workspace, WorkspaceMember, FirebaseVerifyRequest, BaseModel, post, Verifies Firebase ID token (from Google Sign-In). Creates or updates AgencyOS…, verify_firebase() (+13 more)
...
### Community 50 - "kol.py"
Cohesion: 0.13
Nodes (62): KolCampaign, KolCampaignKol, KolCampaignStatus, KolDeliverable, KolDeliverableStatus, KolDeliverableType, KolPaymentStatus, KolProfile (+54 more)
...
### Community 57 - "get_dashboard_overview"
Cohesion: 0.50
...
- **Why does `User` connect `User` to `agents.py`, `models.py`, `competitors.py`, `admin.py`, `posts.py`, `WorkspaceMember`, `statistics.py`, `Session`, `kol.py`, `create_client`, `queue.py`, `ActivityLog`, `reschedule_post`, `get_dashboard_overview`, `delete_agent`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `PostForMeService` connect `PostForMeService` to `posts.py`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `ActivityLog` connect `ActivityLog` to `models.py`, `competitors.py`, `media.py`, `posts.py`, `WorkspaceMember`, `kol.py`, `reschedule_post`, `User`?**

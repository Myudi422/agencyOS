...
## Summary
- 1108 nodes · 2807 edges · 62 communities (44 shown, 18 thin omitted)
...
### Community 0 - "billing.py"
Cohesion: 0.06
Nodes (75): PlanTier, Paket langganan — semua plan unlimited akun sosmed, beda di quota post., Menyimpan OTP WhatsApp sementara untuk verifikasi sebelum claim trial., Setting, SubscriptionPlan, SubscriptionStatus, WaOtpVerification, delete_setting() (+67 more)
...
### Community 2 - "kol.py"
Cohesion: 0.14
Nodes (65): AccountPlatform, ActivityLog, KolCampaign, KolCampaignKol, KolCampaignStatus, KolDeliverable, KolDeliverableStatus, KolDeliverableType (+57 more)
...
### Community 6 - "User"
Cohesion: 0.14
Nodes (41): AccountStatus, RoleEnum, SocialAccount, User, BlueskyConnectRequest, ChallengeResolveRequest, CookieLoginRequest, CredentialLoginRequest (+33 more)
...
Cohesion: 0.09
Nodes (18): Settings, get_db(), get, root(), Migration Script: Add briefing column to social_accounts table, Migration Script: Add social_account_id column to competitor_accounts table, get_current_user_from_token(), get_me() (+10 more)
...
Cohesion: 0.14
Nodes (29): AIBrainstormRequest, AISummaryRequest, _compute_daily_breakdown(), _fetch_all_posts_for_account(), generate_ai_brainstorm(), generate_ai_summary(), get_statistics_accounts(), get_statistics_feed() (+21 more)

### Community 13 - "UserSubscription"
Cohesion: 0.13
Nodes (27): PostType, Subscription aktif milik satu user., UserSubscription, create_media_upload_url(), create_post(), delete_post(), get_posts(), patch_post() (+19 more)

### Community 14 - "get_user_workspace"
Cohesion: 0.12
Nodes (27): AccountBriefingSchema, bulk_action(), BulkActionRequest, delete_account(), get_account_briefing(), get_accounts(), BaseModel, delete (+19 more)
...
Cohesion: 0.36
Nodes (8): Script perbaikan langsung: Ambil hasil dari PostForMe API untuk semua post yang…, JobStatus, Post, PostStatus, PostTarget, PublishJob, Webhook handler untuk menerima event dari PostForMe API. PostForMe mengirim…, reset_and_seed_database()
...
## Knowledge Gaps
- **154 isolated node(s):** `Settings`, `nextConfig`, `name`, `version`, `private` (+149 more)
...
- **Why does `User` connect `User` to `billing.py`, `competitors.py`, `kol.py`, `create_client`, `database.py`, `statistics.py`, `UserSubscription`, `get_user_workspace`, `reset_subscriptions.py`, `Session`, `QueueService`, `calendar.py`, `models.py`, `Client`?**
